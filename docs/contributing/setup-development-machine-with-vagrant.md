...
```console
git clone --branch {{ git.tag }} https://github.com/nextlinux/tracee.git
cd tracee
```
...
kubectl apply -n tracee-system \
  -f https://raw.githubusercontent.com/nextlinux/postee/v2.2.0/deploy/kubernetes/hostPath/postee-pv.yaml \
  -f https://raw.githubusercontent.com/nextlinux/postee/v2.2.0/deploy/kubernetes/postee.yaml
```
...
[Vagrantfile]: https://github.com/nextlinux/tracee/blob/{{ git.tag }}/Vagrantfile
...
[Postee]: https://github.com/nextlinux/postee
